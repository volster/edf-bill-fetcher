...
# Re-export the SAP dump parsers + reconciliation extractors moved to
# ``edf_bill_fetcher.processors.sap_parsers`` during the modularization
# refactor (Task 4 — Phase 3).  Re-exports preserve backward-compat with
...
# Re-export the EvidenceEngine class + its 7 helpers moved to
# ``edf_bill_fetcher.collectors.engine`` during the modularization
# refactor (Task 7 — Phase 6).  The class body itself lives in
# ``collectors.engine``; this re-export preserves the legacy
# ``from edf_collector import EvidenceEngine`` import path.  The
# names are stripped by Task 8 (compat shim cleanup).
from edf_bill_fetcher.collectors.engine import EvidenceEngine  # noqa: E402,F401,I001
...
# Re-export SAP matching constants used by ``detect_sap_back_billing_events``
# and friends (Task 7 — Phase 6 strip of SAP constants from monolith).
from edf_bill_fetcher.processors.sap_parsers import (  # noqa: E402,F401,I001
    _SAP_CONFIDENCE_BANDS,
    _SAP_DEBT_MGMT_FLAG_VALUE,
    _SAP_MATCH_AMOUNT_BANDS,
    _SAP_MATCH_DAY_BANDS,
    _SAP_MIN_CLUSTER_SIZE,
)
...
# ---------------------------------------------------------------------------
# Compat re-exports — UI classes extracted to edf_bill_fetcher.ui.app
# ---------------------------------------------------------------------------
from edf_bill_fetcher.ui.app import App, ReportOptionsDialog  # noqa: E402,F401,I001

# ---------------------------------------------------------------------------
# Compat re-exports — CLI functions extracted to edf_bill_fetcher.io.cli
# ---------------------------------------------------------------------------
